...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddWeight.setOnClickListener(v -> startActivity(new Intent(DashboardActivity.this, AddWeightActivity.class)));
        btnGoalSettings.setOnClickListener(v -> startActivity(new Intent(DashboardActivity.this, GoalWeightActivity.class)));
        btnSmsSettings.setOnClickListener(v -> startActivity(new Intent(DashboardActivity.this, SmsSettingsActivity.class)));
    ...
    private void loadWeightGrid() {
        ...
        List<WeightEntry> entries = repository.getAllWeightsForUser(userId);
    ...
    /**
     * Shows a confirmation dialog before permanently deleting a weight entry.
     */
    private void confirmDelete(WeightEntry entry) {
        new AlertDialog.Builder(this)
                .setTitle("Delete weight entry?")
                .setMessage("This will remove the entry from " + entry.getEntryDate() + ".")
                .setPositiveButton("Delete", (dialog, which) -> deleteWeight(entry.getId()))
    ...
    private void deleteWeight(int weightId) {
        int rowsDeleted = repository.deleteWeight(weightId, userId);
        if (rowsDeleted > 0) {
