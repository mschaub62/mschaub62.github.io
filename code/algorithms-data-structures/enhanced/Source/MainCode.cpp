...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(g_Window))
	{
		...
		// inform the scene manager which projection is active so it can
		// optionally hide/show the ground plane in orthographic mode
		g_SceneManager->SetOrthographicProjectionEnabled(
			g_ViewManager->IsOrthographicProjectionEnabled());
