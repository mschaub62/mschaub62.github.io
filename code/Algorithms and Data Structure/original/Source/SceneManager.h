...
private:
	...
	// add this private member variable to the SceneManager class definition
...
public:
	...
	void PrepareScene();
	void RenderScene();
	// set whether orthographic projection is enabled
	void SetOrthographicProjectionEnabled(bool enabled);
	// check whether orthographic projection is enabled
	bool IsOrthographicProjectionEnabled() const;
	void DefineObjectMaterials();
	void SetupSceneLights();
	// Add this method declaration to the public section of SceneManager
