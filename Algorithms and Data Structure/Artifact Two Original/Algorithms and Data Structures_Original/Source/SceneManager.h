...
public:
	...
	// Allows the view manager (or main loop) to inform the scene manager
	// when orthographic projection is active. This is used to hide the
	// ground plane in orthographic mode per the rubric guidance.
	void SetOrthographicProjectionEnabled(bool enabled);
...
private:
	...
	// Tracks whether the view is currently orthographic.
	// (Used to optionally hide the ground plane.)
	bool m_isOrthographicProjectionEnabled = false;
